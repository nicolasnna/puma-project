...
SERVICE_SRC="${SCRIPT_DIR}/boot/puma-web-interface.service"
LAUNCHUP_SRC="${SCRIPT_DIR}/boot/puma-web-interface.sh"

# Definir destinos
SERVICE_DST="/etc/systemd/system/puma-web-interface.service"
LAUNCHUP_DST="/usr/local/bin/puma-web-interface.sh"
...
echo "Habilitando el servicio puma-web-interface..."
systemctl enable puma-web-interface.service

echo "Iniciando el servicio puma-web-interface..."
systemctl start puma-web-interface.service

echo "Instalación completada. El servicio puma-web-interface se ha instalado, habilitado e iniciado."