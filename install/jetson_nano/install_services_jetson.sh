...
declare -A servicios=(
  ...
  ["12"]="puma-rosbridge-server|${FILES_DIR}/puma-rosbridge-server.service|${SERVICE_DST}/puma-rosbridge-server.service|${FILES_DIR}/puma-rosbridge-server.sh|${SCRIPT_DST}/puma-rosbridge-server.sh"
