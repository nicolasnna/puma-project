...
clien_sm_run_plan_custom = actionlib.SimpleActionClient('/puma/state_machine/run_plan_custom', StateMachineAction)
...
def stop_plan_fn(cmd):
  ...
  if state == "RUN_PLAN":
    ...
    return action_state_machine(clien_sm_run_plan_custom, goal)
  return False
