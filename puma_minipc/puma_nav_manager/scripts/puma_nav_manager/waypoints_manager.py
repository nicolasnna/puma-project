...
class WaypointManager:
  ...
  def init_publishers(self, ns):
    self.waypoints_list_pub = rospy.Publisher(ns+'/waypoints_info', WaypointNav, queue_size=5)
  ...
  def start_subscriber(self, ns):
    ...
    self.set_waypoints_sub = rospy.Subscriber(ns+'/set', WaypointNav, self.set_waypoints)
