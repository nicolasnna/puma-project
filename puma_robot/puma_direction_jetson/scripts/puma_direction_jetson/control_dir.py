...
class ControlDir():
    ...
    def __init__(self):
        # Configure ros
        rospy.init_node('puma_direction_jetson_node')
        rospy.Subscriber('puma/direction/command', DirectionCmd, self.__dirDataCallback)
        rospy.Subscriber('puma/direction/status', Int16, self.__statusDirCallback)
