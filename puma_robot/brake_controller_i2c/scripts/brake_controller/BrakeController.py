#!/usr/bin/env python3
import rospy
from brake_controller_msgs.msg import brake_data, brake_control
import time
from brake_controller.i2cArduinoConection import I2cArduinoConection
from brake_controller.arduinoBrakeController import ArduinoBrakeController
...
class BrakeController():
    ...
    def __init__(self):
        ...
        '''
        rospy.init_node('brake_controller', anonymous=True)
        
        rospy.Subscriber('brake_controller/data_control', brake_control, self._control_callback)
        self._pub_status = rospy.Publisher('brake_controller/status', brake_data, queue_size=10)
        self._arduino_controller = ArduinoBrakeController()
        
        self._set_params()
        self._info_brake = brake_data()
    ...
    def publish_info_brake(self):
        ...
        self._info_brake.vel_max = self.velocity
        self._info_brake.acel = self.acceleration
        self._info_brake.pos_max = self.position
